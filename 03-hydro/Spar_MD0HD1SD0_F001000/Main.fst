...
"FATAL"       AbortLevel      - Error level when simulation should abort (string) {"WARNING", "SEVERE", "FATAL"}
        ...
        0.5   DT              - Recommended module time step (s)
...
10.00                  Gravity       - Gravitational acceleration (m/s^2)
...
"ES13.6E2"    OutFmt          - Format used for text tabular output, excluding the time channel.  
---------------------- LINEARIZATION -------------------------------------------
