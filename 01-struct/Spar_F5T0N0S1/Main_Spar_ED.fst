...
Siemens 3.6 MW 130 m rotor diameter. TetraSpar full scale model to verify OpenFAST against HAWC2/OrcaFlex. Input file to be used in Gregory Hayman TCF-mods2 branch. 
---------------------- SIMULATION CONTROL --------------------------------------
False         Echo            - Echo input data to <RootName>.ech (flag)
"FATAL"       AbortLevel      - Error level when simulation should abort (string) {"WARNING", "SEVERE", "FATAL"}
         50   TMax            - Total run time (s)
      0.010   DT              - Recommended module time step (s)
...
---------------------- INPUT FILES ---------------------------------------------
"Spar_ED_ForED.dat"      EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
"unused"                                                 BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"unused"                                                 BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"unused"                                                 BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"../NREL5MW/data/NREL5MW_IW.dat"                                                 InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"../NREL5MW/data/NREL5MW_AD15.05.dat"                                                 AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"NREL5MW_SvD_None.dat"                                                 ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
