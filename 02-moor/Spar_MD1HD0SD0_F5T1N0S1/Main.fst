...
Siemens 3.6 MW 130 m rotor diameter. TetraSpar full scale model to verify OpenFAST against OrcaFlex. Input file to be used in Gregory Hayman TCF-mods2 branch. 
---------------------- SIMULATION CONTROL --------------------------------------
False         Echo            - Echo input data to <RootName>.ech (flag)
"FATAL"       AbortLevel      - Error level when simulation should abort (string) {"WARNING", "SEVERE", "FATAL"}
        50   TMax            - Total run time (s)
        0.02   DT              - Recommended module time step (s). We can run the rigid with dt = 0.005 s.
        ...
        999   DT_UJac         - Time between calls to get Jacobians (s)
...
"HD_Dummy.dat"    HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
"unused"    SubFile         - Name of file containing sub-structural input parameters (quoted string)
"MAP.dat"     MooringFile     - Name of file containing mooring system input parameters (quoted string)
