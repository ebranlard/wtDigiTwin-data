...
def forcing(t,q=None,qd=None,p=None,u=None,z=None):
    ...
    p:  parameters, dictionary with keys: ['KM_00', 'KM_04', 'KM_44', 'M_B', 'g', 'x_BG', 'z_BG']
    ...
    FF[1,0] = -p['KM_04']*q[0]-p['KM_44']*q[1]+p['M_B']*p['g']*p['x_BG']*cos(q[1])+p['M_B']*p['g']*p['z_BG']*sin(q[1])
    return FF
...
def K_lin(q=None,qd=None,p=None,u=None,z=None):
    ...
    KK[1,0] = p['KM_04']
    KK[1,1] = p['KM_44']+p['M_B']*p['g']*p['x_BG']*sin(q[1])-p['M_B']*p['g']*p['z_BG']*cos(q[1])
    return KK
