...
def main():
    ...
    # if True:
        ...
        if bSmallAngle:
            ...
            model.savePython(folder='py' , variables=['MM','FF','MMsa','FFsa','M','C','K','B','Msa','Csa','Ksa','Bsa'], replaceDict=replaceDict, extraSubs=extraSubs)
        else:
            model.savePython(folder='py' , variables=['MM','FF','M','C','K','B'], replaceDict=replaceDict, extraSubs=extraSubs, doSimplify=False)
        ...
        if bSmallAngle:
            model.savePython(folder='py', suffix='noVel_SA', variables=['Msa','Csa','Ksa','Bsa'], replaceDict=replaceDict, extraSubs=extraSubs, doSimplify=True, velSubs=velSubs)
            model.saveTex(folder='tex', suffix='noVel_SA', variables=['Msa','Csa','Ksa','Bsa'], extraHeader='NoVelocity: ',header=True, doSimplify=True, velSubs=velSubs)
