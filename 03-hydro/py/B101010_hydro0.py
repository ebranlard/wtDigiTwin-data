...
def forcing(t,q=None,qd=None,p=None,u=None,z=None):
    ...
    FF[2,0] = p['M_B']*p['g']*p['x_BG']*cos(q[2])+p['M_B']*p['g']*p['z_BG']*sin(q[2])+p['z_B0']*u['F_hx'](t,q,qd)*cos(q[2])-p['z_B0']*u['F_hz'](t,q,qd)*sin(q[2])+u['M_hy'](t,q,qd)
    return FF
...
def K_lin(q=None,qd=None,p=None,u=None,z=None):
    ...
    KK[2,0] = 0
    KK[2,1] = 0
    KK[2,2] = p['M_B']*p['g']*p['x_BG']*sin(q[2])-p['M_B']*p['g']*p['z_BG']*cos(q[2])-p['z_B0']*(-u['F_hx']*sin(q[2])-u['F_hz']*cos(q[2]))
    return KK
