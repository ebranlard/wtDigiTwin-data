...
def forcing(t,q=None,qd=None,p=None,u=None,z=None):
    ...
    if z is not None:
        ...
        qd = z[int(len(z)/2): ] 
    FF = np.zeros((3,1))
    FF[0,0] = p['M_B']*p['z_BG']*qd[2]**2*sin(q[2])+u['F_hx'](t,q,qd)
    FF[1,0] = -p['M_B']*p['g']+p['M_B']*p['z_BG']*qd[2]**2*cos(q[2])+u['F_hz'](t,q,qd)
    FF[2,0] = p['M_B']*p['g']*p['z_BG']*sin(q[2])+p['z_B0']*u['F_hx'](t,q,qd)*cos(q[2])-p['z_B0']*u['F_hz'](t,q,qd)*sin(q[2])+u['M_hy'](t,q,qd)
    return FF
...
def mass_matrix(q=None,p=None,z=None):
    ...
    MM[0,0] = p['M_B']
    MM[0,1] = 0
    MM[0,2] = p['M_B']*p['z_BG']*cos(q[2])
    MM[1,0] = 0
    MM[1,1] = p['M_B']
    MM[1,2] = -p['M_B']*p['z_BG']*sin(q[2])
    MM[2,0] = p['M_B']*p['z_BG']*cos(q[2])
    MM[2,1] = -p['M_B']*p['z_BG']*sin(q[2])
    MM[2,2] = p['J_yy_B']
    return MM
...
def C_lin(q=None,qd=None,p=None,u=None,z=None):
    ...
    CC[0,0] = 0
    CC[0,1] = 0
    CC[0,2] = -2*p['M_B']*p['z_BG']*qd[2]*sin(q[2])
    CC[1,0] = 0
    CC[1,1] = 0
    CC[1,2] = -2*p['M_B']*p['z_BG']*qd[2]*cos(q[2])
    CC[2,0] = 0
    CC[2,1] = 0
    CC[2,2] = 0
    return CC
...
def K_lin(q=None,qd=None,p=None,u=None,z=None):
    ...
    KK[0,0] = 0
    KK[0,1] = 0
    KK[0,2] = -p['M_B']*p['z_BG']*qd[2]**2*cos(q[2])
    KK[1,0] = 0
    KK[1,1] = 0
    KK[1,2] = p['M_B']*p['z_BG']*qd[2]**2*sin(q[2])
    KK[2,0] = 0
    KK[2,1] = 0
    KK[2,2] = -p['M_B']*p['g']*p['z_BG']*cos(q[2])-p['z_B0']*(-u['F_hx']*sin(q[2])-u['F_hz']*cos(q[2]))
    return KK
...
def B_lin(q=None,qd=None,p=None,u=None):
    ...
    BB[1,1] = 1
    BB[1,2] = 0
    BB[2,0] = p['z_B0']*cos(q[2])
    BB[2,1] = -p['z_B0']*sin(q[2])
    BB[2,2] = 1
    return BB
